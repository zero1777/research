...
class RotaryPositionalEncoding(Module):
    def __init__(self, seq_len: int, dim_emb: int, base: int = 10000, eps: float = EPS):
        super().__init__()
...
class SwiGLU(Module):
    ...
    def __init__(self, dim_in: int, bias: bool = True):
        super().__init__()
...
class SelfAttention(Module):
    def __init__(self, seq_len: int, dim_emb: int, dim_k: int = None, dim_v: int = None, causal=True):
        super().__init__()
